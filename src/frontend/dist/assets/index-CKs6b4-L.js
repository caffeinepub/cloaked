  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-texture border-0 shadow-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 text-sm font-sans text-foreground/90 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Space Coast Garden Guide is a small boutique garden and edible fruit operation in East Central Florida. We grow subtropical and tropical fruits, edible trees, and seasonal vegetables in Zone 9b/10a." }),
...
const LISTINGS = [
  {
    ...
    description: "Morus nigra — the real mulberry. Full-size tree producing large, deeply flavored dark berries with a richness unmatched by any dwarf variety. Prized for centuries, thrives in Florida's climate. 3-gallon pot, approx 2–3 feet tall.",
    price: "$25",
    available: true,
  ...
  },
  {
    id: 5,
    name: "Rosemary Plant",
    description: "Robust culinary rosemary — fragrant, flavorful, and surprisingly tough in Florida's heat. Thrives in containers or garden beds with good drainage. Harvest year-round for cooking, teas, and roasting.",
    price: "$6",
    available: true,
  ...
  },
  {
    ...
    description: "Vigorous producer of small, intensely hot peppers that love Florida's heat. Loaded with clusters of fruit from spring through fall. Perfect for containers or raised beds — a must for any hot sauce garden.",
    price: "$5",
    available: true,
  ...
  },
  {
    ...
    description: "A true Florida dream — young coconut palm in a 5-gallon container, ready to establish roots in your yard. Thrives in our coastal heat and sandy soil. Give it full sun, occasional deep water, and patience. Tropical abundance starts here.",
    price: "$35",
    available: true,
  ...
  },
  {
    id: 8,
    name: "Turmeric Plant",
    description: "Curcuma longa — the golden root. Grown from rhizome divisions, this lush tropical grower thrives in Florida's warm, humid summers. Harvest the fresh roots in late fall for cooking, juicing, or replanting. Anti-inflammatory, anti-everything-bad.",
    price: "$8",
    available: true,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      background: "linear-gradient(135deg, oklch(0.42 0.09 148) 0%, oklch(0.35 0.07 160) 100%)"
                    },
